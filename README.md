...
1. **Visit the Application:**  [**CPI Prediction**](https://cpi-predictor-g3brcfdcece8a3g4.southeastasia-01.azurewebsites.net) and if this link doesn't work then [click here](https://cpi-predicition-2.onrender.com/)
