...
1. **Visit the Application:** [**CPI Prediction**](cpi-predictor-g3brcfdcece8a3g4.southeastasia-01.azurewebsites.net) if this doesn't work then [**Click Here**](https://cpi-predicition-2.onrender.com/)
